...
const EQUIPMENT_BRANDS = [
  ...
  {
    name: "Balanced Body",
    tagline: "The world’s leading reformer brand. Used in more studios than any other.",
    tier: "Professional",
    priceRange: "$$$$",
  ...
  },
  {
    ...
    tagline: "Contemporary method’s flagship brand. The V2 Max is the industry benchmark.",
    tier: "Professional",
    priceRange: "$$$$",
    href: "/blog/balanced-body-vs-merrithew",
