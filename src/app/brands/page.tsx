...
const EQUIPMENT_BRANDS = [
  ...
  {
    name: "BASI Systems",
    tagline: "Designed by Rael Isacowitz. The longest carriage in the industry. For athletes and dancers.",
    tier: "Professional",
    priceRange: "$$$$",
    href: "/blog/basi-systems-pilates",
    imageUrl: "/pictures/ahmet-kurt-0xn-8kRWOhE-unsplash.jpg",
    bestFor: "Athletes, dancers, tall users",
    topPick: "BASI Systems Reformer",
  },
  {
    name: "Align-Pilates",
    tagline: "UK-engineered robustness. The A8-Pro is a studio workhorse; the H1 folds without compromise.",
    tier: "Professional",
    priceRange: "$$$",
    href: "/blog/align-pilates-reformer-review",
    imageUrl: "/pictures/junseong-lee-G9H5edUL0T8-unsplash.jpg",
    bestFor: "Studios & home use",
    topPick: "C8 Pro / A8-Pro",
  },
  {
    name: "AeroPilates",
    tagline: "The gateway brand. Built-in Cardio Rebounder, foldable design, and a budget-friendly entry point.",
    tier: "Mid",
    priceRange: "$$",
    href: "/blog/aeropilates-review",
    imageUrl: "/pictures/junseong-lee-AX8cf6mkCzw-unsplash.jpg",
    bestFor: "Beginners & budget home",
    topPick: "Pro XP 557",
  },
  {
    name: "Your Reformer",
    tagline: "The connected home studio. Beautiful wood reformer paired with a world-class on-demand app.",
    tier: "Premium",
    priceRange: "$$$",
    href: "/blog/your-reformer-pilates",
    imageUrl: "/pictures/henrique-ferreira-omiTbS-nb_M-unsplash.jpg",
    bestFor: "Home practitioners",
    topPick: "The Original",
  },
  {
    name: "PersonalHour",
