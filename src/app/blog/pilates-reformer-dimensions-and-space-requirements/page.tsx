...
const PRODUCTS = [
  ...
  { name: "Laser Distance Measure", description: "Worth the twenty minutes before a four-figure order. A laser measure gets you accurate ceiling height, doorway widths and corridor turns faster and more reliably than a tape you are holding above your head, and ceiling height is the measurement people guess at and then regret guessing at.", price: "From $30", affiliateUrl: "https://www.amazon.com/s?k=laser+distance+measure+tape&tag=pilatescollective-20" },
  { name: "Rubber Floor Protection Mat", description: "A reformer concentrates a lot of weight on four small feet, which dents timber and compresses carpet permanently. A mat under the frame spreads the load, protects a rented floor, and noticeably cuts the carriage noise transmitted into the room below, which matters in an apartment.", price: "From $40", affiliateUrl: "https://www.amazon.com/s?k=rubber+equipment+floor+protection+mat+gym&tag=pilatescollective-20" },
  { name: "Reformer Cover", description: "If the machine lives in a living space rather than a dedicated room, a fitted cover keeps dust off the upholstery and the springs and makes the thing read as furniture rather than gym equipment. That sounds cosmetic and it is the reason some people keep a reformer at home rather than selling it.", price: "From $35", affiliateUrl: "https://www.amazon.com/s?k=pilates+reformer+cover+dust+protective&tag=pilatescollective-20" },
];
