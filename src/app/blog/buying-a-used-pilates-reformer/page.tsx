...
const PRODUCTS = [
  ...
  { name: "Wheel and Rail Cleaning Kit", description: "Do this before concluding a used machine has a bearing problem. Most carriage noise and most gritty glide is dirt compacted in the rail track, and a proper clean restores the feel at no cost. It is also the highest-return maintenance task on any reformer, new or old, and takes about twenty minutes.", price: "From $20", affiliateUrl: "https://www.amazon.com/s?k=equipment+cleaning+kit+microfiber+lubricant+silicone&tag=pilatescollective-20" },
  { name: "Vinyl-Safe Upholstery Cleaner and Conditioner", description: "The right first treatment for upholstery that has had a previous owner. A conditioner formulated for vinyl and leatherette restores some flexibility to a pad that has dried out and slows the progression toward cracking. Avoid anything alcohol or bleach based, which is what caused the drying in the first place.", price: "From $18", affiliateUrl: "https://www.amazon.com/s?k=vinyl+upholstery+cleaner+conditioner+gym+equipment&tag=pilatescollective-20" },
  { name: "Non-Slip Reformer Carriage Pad", description: "A practical answer to upholstery that is sound but slick with age. A grip pad makes standing and kneeling work feel secure again and protects what is left of the original vinyl. Much cheaper than re-upholstery and a reasonable interim step while you decide whether the machine is worth the full job.", price: "From $30", affiliateUrl: "https://www.amazon.com/s?k=pilates+reformer+non+slip+carriage+pad+grip&tag=pilatescollective-20" },
  { name: "Furniture Sliders and Moving Straps", description: "Private sales never come with delivery. You are collecting a long, heavy machine from someone's studio or spare room, and sliders plus a pair of moving straps turn that from a two-person struggle into something manageable without damaging either floor. Bring them with you rather than hoping the seller has some.", price: "From $20", affiliateUrl: "https://www.amazon.com/s?k=furniture+moving+straps+sliders+heavy&tag=pilatescollective-20" },
];
        ...
        <section className="px-6 pb-20">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mb-14">
              ...
              <p className="text-base leading-relaxed mb-4" style={{ color: "#53433e", fontFamily: "'Montserrat', sans-serif" }}>
                For reference, current new pricing on machines that commonly appear secondhand: the Balanced Body Allegro 2 is $3,995 standard, the Balanced Body Studio Reformer is $4,400 to $4,800 depending on footbar, and the Align Pilates C8 Pro runs around $2,750 to $2,900. Those are the numbers to discount from. Our{" "}
