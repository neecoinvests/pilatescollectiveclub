...
const PRODUCTS = [
  { name: "Manduka PRO Pilates Mat", description: "The foundation of the mat system — Joseph Pilates' 34 exercises require only a mat. If you are choosing between mat and reformer practice, a high-quality mat is the essential starting point.", price: "From $98", affiliateUrl: "https://www.amazon.com/s?k=manduka+pro+pilates+mat&tag=pilatescollective-20" },
  { name: "Home Pilates Reformer", description: "If budget and space allow, a home reformer transforms what is achievable in independent practice. Entry-level machines from AeroPilates and Merrithew start the reformer system at accessible price points.", price: "From $299", affiliateUrl: "https://www.amazon.com/s?k=pilates+reformer+home+studio&tag=pilatescollective-20" },
  { name: "Balanced Body Magic Circle", description: "Bridges mat and reformer practice — provides the lateral resistance that the reformer springs offer, making it the best single tool for bringing reformer benefits to mat sessions.", price: "From $35", affiliateUrl: "https://www.amazon.com/s?k=balanced+body+magic+circle+pilates&tag=pilatescollective-20" },
  { name: "TheraBand Resistance Bands Set", description: "Resistance bands provide spring-like resistance for mat practice. Not a substitute for the reformer, but a meaningful upgrade to mat-only home practice that approximates some of what the springs add.", price: "From $22", affiliateUrl: "https://www.amazon.com/s?k=theraband+resistance+bands+set&tag=pilatescollective-20" },
  { name: "OPTP Foam Roller (36-inch)", description: "Adds the spinal articulation and thoracic mobility work that the reformer supports through its spring system. A core tool for anyone whose practice is primarily mat-based.", price: "From $29", affiliateUrl: "https://www.amazon.com/s?k=OPTP+foam+roller+36+inch&tag=pilatescollective-20" },
];
