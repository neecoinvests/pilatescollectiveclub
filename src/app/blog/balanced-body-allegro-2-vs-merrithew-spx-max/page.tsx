...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        { "@type": "Question", "name": "Which is better, the Allegro 2 or the SPX Max?", "acceptedAnswer": { "@type": "Answer", "text": "Neither is better in the abstract, and they solve different problems. The SPX Max folds flat and rolls away, which makes it the answer in a room the machine cannot permanently occupy, and it costs meaningfully less. The Allegro 2 folds upright against a wall, sits inside the deepest accessory ecosystem in the industry, and holds its value better on resale. If the machine has to disappear between sessions, the SPX Max wins on the mechanism alone. If it can stay up and you expect to add a tower, boxes and converters over years, the Allegro 2 is the better platform." } },
        { "@type": "Question", "name": "How much do the Allegro 2 and SPX Max cost?", "acceptedAnswer": { "@type": "Answer", "text": "The Balanced Body Allegro 2 is $3,995 for the standard machine and around $4,325 to $4,345 with the leg kit, checked against dealer listings in September 2026. The Merrithew SPX Max sits well below that. Merrithew pricing varies substantially between the base machine and the several bundles it is sold in, and between dealers, so confirm the current figure for the exact configuration with an authorised dealer rather than working from a headline number. Compare delivered totals including freight, since on machines this size that difference can be hundreds of dollars." } },
...
const COMPARISON = [
  ...
  },
  {
    ...
    b: "Materially below the Allegro 2. Merrithew prices the base machine and its bundles very differently, so confirm the current figure for your exact configuration with an authorised dealer.",
  },
];
        ...
        <section className="pt-32 pb-16 px-6" style={{ backgroundColor: "#fcf9f8" }}>
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg leading-relaxed" style={{ color: "#53433e", fontFamily: "'Montserrat', sans-serif", fontWeight: 300 }}>
              These are the two machines serious home buyers cross-shop most, and the comparison is usually framed as a price question. It is not. They fold in different directions, and that single mechanical difference decides the purchase for most people before any other factor gets a vote. Price matters second, and the accessory ecosystem matters third, over a longer horizon than most buyers are thinking about.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mb-14 mt-4 rounded-2xl p-7" style={{ backgroundColor: "#fff4f1", border: "1px solid rgba(139,74,49,0.15)" }}>
              ...
              <p className="text-base leading-relaxed mb-0" style={{ color: "#53433e", fontFamily: "'Montserrat', sans-serif" }}>
                The machine has to disappear between sessions: SPX Max, because the flat fold and castors are a genuinely different capability and no discount on the other machine changes that. The machine can stay up and you intend to build around it with a tower, boxes and converters: Allegro 2, for the ecosystem and the resale. Budget is the binding constraint: SPX Max, which costs meaningfully less for a machine that does the same repertoire.
              </p>
            </div>
            ...
            <div className="mb-14">
              <h2 className="text-3xl font-semibold mb-6" style={{ color: "#1b1c1c", fontFamily: "'Playfair Display', serif" }}>On price, and why we are not printing one number</h2>
              <p className="text-base leading-relaxed mb-4" style={{ color: "#53433e", fontFamily: "'Montserrat', sans-serif" }}>
                The Allegro 2 is $3,995 for the standard machine and around $4,325 to $4,345 with the leg kit. We checked that against current dealer listings in September 2026.
              </p>
              <p className="text-base leading-relaxed mb-4" style={{ color: "#53433e", fontFamily: "'Montserrat', sans-serif" }}>
                The SPX Max sits well below it, and we would rather tell you that than give you a precise figure we have not been able to confirm to the same standard. Merrithew sells the base machine and several bundles at meaningfully different prices, and dealer pricing varies on top of that, so a single headline number is misleading for this machine in a way it is not for the Allegro 2. Get a quote for the exact configuration you want.
              </p>
              <p className="text-base leading-relaxed" style={{ color: "#53433e", fontFamily: "'Montserrat', sans-serif" }}>
            ...
            <div className="mb-14">
              ...
              <div className="space-y-6">
                {[
                  ...
                  { q: "How much do the Allegro 2 and SPX Max cost?", a: "The Balanced Body Allegro 2 is $3,995 for the standard machine and around $4,325 to $4,345 with the leg kit, checked against dealer listings in September 2026. The Merrithew SPX Max sits well below that. Merrithew pricing varies substantially between the base machine and the several bundles it is sold in, and between dealers, so confirm the current figure for the exact configuration with an authorised dealer rather than working from a headline number. Compare delivered totals including freight, since on machines this size that difference can be hundreds of dollars." },
