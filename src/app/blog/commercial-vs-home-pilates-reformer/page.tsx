...
const REFORMERS = [
  ...
  { name: "AeroPilates Pro XP 557 Reformer", description: "The one machine from a recognised brand that genuinely costs under $2,000. It uses elastic cord rather than coil springs, which is a real difference in how resistance builds, but for building a habit it is a workable trade.", price: "From $1,329", affiliateUrl: "https://www.amazon.com/dp/B0012TJI8S?tag=pilatescollective-20" },
...
const PRODUCTS = [
  { name: "Colaxi 5-Piece Reformer Spring Set", description: "The wear part that defines both tiers. Commercial machines treat springs as scheduled consumables with catalogued replacements; many budget machines do not. This is an aftermarket, universal-ish fit set rather than brand-OEM, so check it against your exact model before ordering, since spring ends and lengths are not interchangeable across brands.", price: "$65.54", affiliateUrl: "https://www.amazon.com/dp/B0DC93JC3M?tag=pilatescollective-20" },
  { name: "Balanced Body Replacement Reformer Ropes with Clips", description: "Ropes stretch and fray, and a stretched rope changes the working length of every strap exercise without anyone noticing the cause. Replace them as a set rather than individually so both sides match, and confirm the fit for your exact model before ordering.", price: "$35", affiliateUrl: "https://www.amazon.com/dp/B0CYM27QMZ?tag=pilatescollective-20" },
  { name: "Amazon Basics Microfiber Cloths (24-pack)", description: "Carriage noise and a gritty glide are almost always dirt in the wheel track rather than a worn bearing. Cleaning the rails and wheels on a schedule with a dry, then barely damp, microfiber cloth is the single highest-return maintenance task on any reformer, and it is the difference between a machine that feels studio-grade at year five and one that does not.", price: "$10.38", affiliateUrl: "https://www.amazon.com/dp/B009FUF6DM?tag=pilatescollective-20" },
  { name: "STAR BRITE Ultimate Vinyl Clean", description: "Upholstery is the first thing to look tired on any reformer at any price. Alcohol-heavy and bleach-based cleaners dry the vinyl until it cracks, which converts a wipe-down into a re-upholstery bill. A formula rated for vinyl and leatherette costs the same and does not do that.", price: "$14.95", affiliateUrl: "https://www.amazon.com/dp/B01CZ2ZW4O?tag=pilatescollective-20" },
  { name: "Balanced Body Padded Jumpboard", description: "Available for the Studio Reformer and Allegro line and the cheapest way to add a genuinely different training stimulus to a reformer you already own. Mount-specific — confirm the fit for your exact machine before ordering.", price: "$280", affiliateUrl: "https://www.amazon.com/dp/B08CS4LJZ7?tag=pilatescollective-20" },
  { name: "Eccentfit Pilates Grip Pads (4-pack)", description: "A thin grip pad is the cheapest fix for a carriage that has become slick with use, and it makes standing and kneeling work feel secure on an older machine. Worth having on a home reformer where the upholstery is past its best but the frame is sound.", price: "$7.99", affiliateUrl: "https://www.amazon.com/dp/B0GGR4QXNH?tag=pilatescollective-20" },
];
        ...
        <section className="px-6 pb-20">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mb-14">
              ...
              <p className="text-base leading-relaxed mb-4" style={{ color: "#53433e", fontFamily: "'Montserrat', sans-serif" }}>
                Above that, the studio standard from the established brands runs from roughly $2,750 for an Align Pilates C8-PRO to around $4,700 for a Balanced Body Studio Reformer, and classical wood and aluminium apparatus from Gratz reaches $5,000 and beyond. The premium at the top is buying refinement, lineage and resale value rather than a step change in durability, which is worth knowing before assuming that more money means a more robust machine.
              </p>
              <p className="text-base leading-relaxed" style={{ color: "#53433e", fontFamily: "'Montserrat', sans-serif" }}>
