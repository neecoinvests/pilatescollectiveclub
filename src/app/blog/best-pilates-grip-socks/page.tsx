...
const PRODUCTS = [
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=toesox+half+toe+low+rise+grip+socks&tag=matchaspot-20",
    tag: "Editor's Pick",
  },
  {
    rank: "02",
    ...
    affiliateUrl: "https://www.amazon.com/s?k=tavi+noir+nola+grip+socks+pilates&tag=matchaspot-20",
    tag: "Most Popular",
  },
  {
    rank: "03",
    ...
    affiliateUrl: "https://www.amazon.com/s?k=shashi+loop+grip+socks&tag=matchaspot-20",
    tag: "Style Pick",
  },
  {
    rank: "04",
    ...
    affiliateUrl: "https://www.amazon.com/s?k=bellarina+grip+socks+pilates&tag=matchaspot-20",
    tag: "Best Value",
  },
  {
    rank: "05",
    ...
    affiliateUrl: "https://www.amazon.com/s?k=sticky+be+socks+grip&tag=matchaspot-20",
    tag: "Mat & Barre",
  },
];
...
export default function BestGripSocksPage() {
  return (
    <>
      ...
      <ProductListSchema products={PRODUCTS.map(p => ({ name: p.name, description: p.description, price: p.price })} pageUrl="https://pilatescollectiveclub.com/blog/best-pilates-grip-socks" />
      <Header />
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Journal", href: "/blog" }, { label: "Best Pilates Grip Socks (2026): 5 Options Studio-Tested & Ranked" }]} />
      <main>
