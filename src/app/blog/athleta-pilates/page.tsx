...
export const metadata: Metadata = {
  ...
  description: "The best Athleta pieces for Pilates — Salutation Stash Tight, Transcend, Elation reviewed. Gap's B Corp brand offers premium quality at a meaningful discount to Lululemon.",
...
const PRODUCTS = [
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=athleta+salutation+stash+tight+legging&tag=matchaspot-20",
    tag: "Top Pick",
  },
  {
    rank: "02",
    ...
    affiliateUrl: "https://www.amazon.com/s?k=athleta+transcend+tight+legging&tag=matchaspot-20",
  ...
  },
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=athleta+elation+tight+7%2F8&tag=matchaspot-20",
    tag: "Best 7/8 Length",
  },
  {
    rank: "04",
    ...
    affiliateUrl: "https://www.amazon.com/s?k=athleta+exhale+sports+bra&tag=matchaspot-20",
    tag: "Best Bra",
  },
  {
    rank: "05",
    ...
    affiliateUrl: "https://www.amazon.com/s?k=athleta+headlands+hoodie+layer&tag=matchaspot-20",
    tag: "Best Layer",
  },
];
...
export default function AthletaPilatesPage() {
  return (
    <>
      ...
      <ProductListSchema products={PRODUCTS.map(p => ({ name: p.name, description: p.description, price: p.price }))} pageUrl="https://pilatescollectiveclub.com/blog/athleta-pilates" />
      <Header />
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Journal", href: "/blog" }, { label: "Athleta for Pilates (2026): Best Leggings & Honest Review" }]} />
      <main>
