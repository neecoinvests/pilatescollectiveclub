...
export const metadata: Metadata = {
  title: "Best Pilates Leggings (2026): Squat-Proof & Ranked",
  description: "Eight Pilates leggings tested for opacity under stretch, waistband hold through inversions, and how each one behaves on a reformer carriage.",
