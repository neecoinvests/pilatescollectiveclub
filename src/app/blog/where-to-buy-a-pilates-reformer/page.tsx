...
const PRODUCTS = [
  ...
  { name: "Furniture Sliders and Moving Straps", description: "If delivery is kerbside, this is the difference between a manageable afternoon and a damaged floor. Sliders let two people move a crated or assembled machine across a room without dragging it. Cheap, and you will use them again every time the room gets rearranged.", price: "From $20", affiliateUrl: "https://www.amazon.com/s?k=furniture+moving+straps+sliders+heavy&tag=pilatescollective-20" },
  { name: "Laser Distance Measure", description: "Buy this before you buy the reformer. Doorway widths, corridor turns, lift depth and ceiling height are the measurements that decide whether a delivery succeeds, and they are the ones people estimate. Twenty minutes of measuring is cheap insurance on a four-figure order.", price: "From $30", affiliateUrl: "https://www.amazon.com/s?k=laser+distance+measure+tape&tag=pilatescollective-20" },
  { name: "Rubber Floor Protection Mat", description: "A reformer puts a lot of weight on four small feet. A mat under the frame spreads the load, protects a rented or timber floor, and cuts the carriage noise transmitted through the building. Order it to arrive before the machine does, because sliding a mat under an assembled reformer is a two-person job.", price: "From $40", affiliateUrl: "https://www.amazon.com/s?k=rubber+equipment+floor+protection+mat+gym&tag=pilatescollective-20" },
  { name: "Vinyl-Safe Upholstery Cleaner", description: "The first thing to do with any machine that has had a previous owner, and the right habit on a new one. Alcohol-heavy and bleach-based cleaners dry reformer upholstery until it cracks, so use a formula rated for vinyl and leatherette from the start rather than discovering the difference in year three.", price: "From $18", affiliateUrl: "https://www.amazon.com/s?k=vinyl+upholstery+cleaner+conditioner+gym+equipment&tag=pilatescollective-20" },
];
