  ...
  return (
    <>
      ...
      <main>
        <section className="pt-32 pb-16 px-6" style={{ backgroundColor: "#fcf9f8" }}>
          <div className="max-w-3xl mx-auto">
            <div className="flex items-center gap-3 mb-6">
              <span className="text-xs font-semibold uppercase tracking-[0.2em]" style={{ color: "#8b4a31", fontFamily: "'Montserrat', sans-serif" }}>Beginner Guide</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-semibold leading-[1.15] mb-6" style={{ color: "#1b1c1c", fontFamily: "'Playfair Display', serif" }}>
              The Beginner&apos;s Guide to<br />
              <span style={{ color: "#8b4a31" }}>Reformer Pilates</span>
            </h1>
            ...
            <p className="text-lg leading-relaxed" style={{ color: "#53433e", fontFamily: "'Montserrat', sans-serif", fontWeight: 300 }}>
              Reformer Pilates is having a moment — but the interest it&apos;s generating isn&apos;t unfounded. The reformer is one of the most sophisticated and effective pieces of exercise equipment ever designed, and the classes built around it are among the most intelligent in the fitness world. If you&apos;re curious but not sure where to start, this guide covers everything you need to know before you book your first class.
            </p>
          </div>
        </section>
        ...
        <CTASection title="Find a reformer studio near you" subtitle="Use our city guides to discover highly rated Pilates studios worldwide." showSearch searchPlaceholder="Ask: best beginner reformer Pilates near me…" />
      </main>
      <Footer />
    </>
  );
