...
export const metadata: Metadata = {
  ...
  description: "The honest comparison of Pilates and yoga — core focus, equipment, philosophy, back pain evidence, and how to decide which practice is right for your body and goals.",
  openGraph: {
...
export default function PilatesVsYogaPage() {
  return (
    <>
      ...
      <Header />
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Journal", href: "/blog" }, { label: "Pilates vs Yoga (2026): Key Differences & How to Choose" }]} />
      <main>
        <BlogHero
