...
const PRODUCTS = [
  { name: "Reformer Replacement Springs", description: "The core of any maintenance programme. Springs lose tension gradually rather than failing dramatically, so the machine drifts away from its calibration without anyone noticing a moment when it changed. Replace as a full set so the colour gradation stays meaningful. Spring ends, lengths and tensions are model-specific and not interchangeable across brands, so order for your exact machine.", price: "From $45", affiliateUrl: "https://www.amazon.com/s?k=pilates+reformer+replacement+springs&tag=pilatescollective-20" },
  { name: "Reformer Ropes and Straps", description: "Ropes stretch under load over time, and a stretched rope quietly changes the working length of every strap exercise. Because it happens on both sides at different rates, the first symptom is usually asymmetry that a practitioner feels but cannot name. Replace as a matched pair. Adjustable ropes are a worthwhile upgrade on older machines with fixed lengths.", price: "From $35", affiliateUrl: "https://www.amazon.com/s?k=pilates+reformer+ropes+straps+replacement&tag=pilatescollective-20" },
  { name: "Microfiber Cloths and Rail Cleaning Kit", description: "The highest-return maintenance task there is, and the cheapest. Compacted dust in the rail track is the cause of most carriage noise and most gritty glide, and a dry microfiber cloth along the rails fixes it. Keep a set with the machine so the job actually gets done rather than deferred.", price: "From $20", affiliateUrl: "https://www.amazon.com/s?k=microfiber+cleaning+cloths+equipment+kit&tag=pilatescollective-20" },
  { name: "Vinyl-Safe Disinfectant Wipes", description: "The correct product for wiping down between sessions. Alcohol-heavy and bleach-based wipes clean perfectly well and destroy vinyl over a couple of years by drying out the plasticisers until the surface cracks. A wipe rated for vinyl and leatherette costs the same and does not do that. In a studio this is a recurring budget line, not a one-off.", price: "From $30", affiliateUrl: "https://www.amazon.com/s?k=gym+equipment+disinfectant+wipes+vinyl+safe&tag=pilatescollective-20" },
  { name: "Vinyl Upholstery Conditioner", description: "Periodic conditioning restores some flexibility to upholstery that has dried out, and it is genuinely preventative rather than cosmetic: flexible vinyl resists cracking, and cracking is what ends a pad. Worth doing a few times a year on any machine in a dry room, near a radiator, or in direct sun.", price: "From $18", affiliateUrl: "https://www.amazon.com/s?k=vinyl+upholstery+conditioner+restorer&tag=pilatescollective-20" },
  { name: "Non-Slip Carriage Pad", description: "The practical answer to upholstery that is structurally sound but has gone slick with age. A grip pad restores confidence for standing and kneeling work and protects what is left of the original surface. Considerably cheaper than re-upholstery and a sensible way to extend a pad that is not yet cracked.", price: "From $30", affiliateUrl: "https://www.amazon.com/s?k=pilates+reformer+non+slip+carriage+pad+grip&tag=pilatescollective-20" },
];
