...
const REFORMERS = [
  {
    ...
    tag: "Best Overall",
    description: "The AeroPilates Pro XP 557 is one of the most widely sold home reformers in the US market. It uses elastic cord resistance rather than coil springs — a genuinely different feel from a studio machine, more forgiving and less precise at the top of the resistance range — but it still trains the core reformer movement patterns: footwork, the carriage, a foot bar. We could not verify a folding mechanism, exact folded dimensions, or a specific weight rating for this listing, so check the current Amazon listing for those details before ordering.",
    affiliateUrl: "https://www.amazon.com/dp/B0012TJI8S?tag=pilatescollective-20",
    pros: ["Real, currently-sold Amazon listing", "Smooth-rolling carriage", "Genuinely space-efficient compared to a studio reformer"],
    cons: ["Elastic cord resistance, not coil springs — a real difference from a professional machine", "We could not verify folding, exact dimensions, or weight rating — check the listing", "Limited advanced exercise options"],
  },
  {
    rank: 2,
  ...
  },
  {
    ...
    cons: ["Meaningful step up in price from AeroPilates models", "We could not verify a folding mechanism — check before assuming it stores flat", "Heavier than consumer cord-based reformers"],
  },
  {
    rank: 4,
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mb-14 rounded-2xl p-8" style={{ backgroundColor: "#f6f3f2", border: "1px solid rgba(217,194,186,0.35)" }}>
              ...
              <ul className="space-y-3">
                {[
                  "Budget under $600: an AeroPilates elastic-cord reformer (the 701 Premier or 287) is the accessible entry point — cord resistance rather than springs, but a genuine reformer movement pattern.",
                  "Budget $1,000–$2,500: the Balanced Body Metro IQ is a real, smaller-footprint coil-spring machine actually sold on Amazon — a meaningful step up in resistance feel from cord-based models.",
                  ...
                  "Space constraint: we could not verify folding mechanisms or folded dimensions for the models above, so measure your available floor space against each listing's actual footprint before ordering rather than assuming a machine folds away.",
