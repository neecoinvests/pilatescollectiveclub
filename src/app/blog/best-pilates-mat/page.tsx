...
export default function BestPilatesMatPage() {
  return (
    <>
      ...
      <ProductListSchema products={PRODUCTS.map(p => ({ name: p.name, description: p.description, price: p.price })} pageUrl="https://pilatescollectiveclub.com/blog/best-pilates-mat" />
      <Header />
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Journal", href: "/blog" }, { label: "Best Pilates Mat (2026): Firmness, Grip & Spinal Feedback Tested" }]} />
      <main>
