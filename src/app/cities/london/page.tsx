  ...
  "@graph": [
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "London", "item": "https://pilatescollectiveclub.com/cities/london" },
      ],
    },
    {
      "@type": "ItemList",
...
export default function LondonPage() {
  return (
    <>
      ...
      <Header />
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Studio Guides", href: "/cities" }, { label: "London" }]} />
      <main>
