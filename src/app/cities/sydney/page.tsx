  ...
  "@graph": [
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Sydney", "item": "https://pilatescollectiveclub.com/cities/sydney" },
      ],
    },
    {
      "@type": "ItemList",
...
export default function SydneyPage() {
  return (
    <>
      ...
      <Header />
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Studio Guides", href: "/cities" }, { label: "Sydney (2026)" }]} />
      <main>
