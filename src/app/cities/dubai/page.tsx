  ...
  "@graph": [
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Dubai", "item": "https://pilatescollectiveclub.com/cities/dubai" },
      ],
    },
    {
      "@type": "ItemList",
...
export default function DubaiPage() {
  return (
    <>
      ...
      <Header />
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Studio Guides", href: "/cities" }, { label: "Dubai (2026)" }]} />
      <main>
