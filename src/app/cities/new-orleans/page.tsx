...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1568402102990-bc541580b59f?w=1200&h=630&fit=crop",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      "https://images.unsplash.com/photo-1568402102990-bc541580b59f?w=1200&h=630&fit=crop",
    ],
  },
  alternates: {
      ...
      <main>
        ...
        <section className="px-6 mb-16">
          <div className="max-w-5xl mx-auto relative rounded-2xl overflow-hidden" style={{ height: "420px" }}>
            <Image
              src="https://images.unsplash.com/photo-1568402102990-bc541580b59f?w=1400&h=840&fit=crop"
              alt="Pilates studio in New Orleans, LA"
              fill
