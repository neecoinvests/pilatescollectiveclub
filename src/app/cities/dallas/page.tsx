...
const STUDIOS = [
  {
    number: "01",
    name: "The Pilates Room Dallas",
    neighborhood: "Highland Park",
    priceLevel: "$$$$",
    review: "The Pilates Room in Highland Park operates at the premium end of Dallas's studio market and justifies its position through the consistent quality of its instruction and the depth of its apparatus programme. The studio teaches the classical method without apology — Reformer, Cadillac, Wunda Chair, and Ladder Barrel are all in regular use — and the teaching team has the training and experience to deploy the full apparatus suite intelligently rather than as window dressing. Highland Park's sophisticated, internationally travelled clientele has the body literacy to recognise and reward this depth, which has created a stable community of serious long-term practitioners. The studio is particularly well-regarded for its work with professional athletes and performing artists who need the precision of the classical system to address specific physical challenges.",
    address: "—",
    bestFor: "Classical full apparatus, advanced practitioners, athletes",
    signatureClass: "Classical Reformer & Cadillac",
    bookingTip: "Private and semi-private sessions are the primary offering; contact the studio for intake and availability — the waitlist for senior instructors is long",
  },
  {
    number: "02",
    name: "Uptown Pilates",
    ...
    priceLevel: "$$$",
    review: "Uptown Pilates has established itself as the anchor Pilates practice in one of Dallas's most commercially vibrant and fitness-invested neighbourhoods. The studio's contemporary reformer programme serves Uptown's professional population — young finance and tech workers, consultants, and the entertainment-adjacent creative class — with sessions that are physically demanding, efficiently structured, and taught by instructors who balance high energy with genuine instructional care. The Uptown location benefits from exceptional accessibility — walkable from several residential towers and close to the major transit corridors — and the schedule is dense enough to accommodate the unpredictable work patterns of the area's professional population. A reliable, well-run studio that has maintained its standards through several years of Dallas's rapidly shifting boutique fitness landscape.",
    address: "—",
    bestFor: "Young professionals, contemporary reformer, Uptown convenience",
    signatureClass: "Reformer Flow",
    bookingTip: "Lunchtime and early evening slots fill fastest with the professional clientele; book at least 5 days ahead for these windows",
  },
  {
    number: "03",
    name: "Iron Pilates",
    ...
    priceLevel: "$$$",
    review: "Iron Pilates in Lower Greenville has built a strong reputation among Dallas's fitness community by applying genuine athletic rigour to the reformer format without losing the method's foundational principles. The studio's name reflects its ethos: sessions here are physically demanding and programming is periodised to produce measurable strength and stability improvements over time, rather than the indefinite plateau that poorly sequenced group reformer can produce. Lower Greenville's active, outdoors-oriented population — cyclists, runners, and tennis players who use Pilates as complementary training — has found in Iron Pilates a studio that truly understands how the method integrates with broader athletic lives. Instructors have strong sports science backgrounds and the programming reflects this in practical, results-oriented terms.",
    address: "—",
    bestFor: "Athletic conditioning, cross-training, serious reformer",
    signatureClass: "Athletic Reformer",
    bookingTip: "Early morning slots are popular with the athletic clientele; booking by mid-week for the following week is advisable",
  },
  {
    number: "04",
    ...
    priceLevel: "$$$",
    review: "Club Pilates Preston Hollow serves one of Dallas's wealthiest residential areas with a franchise reformer programme that is among the most consistently well-delivered in the Texas network. The Preston Hollow clientele — established business families, healthcare professionals, and long-term Dallas residents with high wellness awareness — has attracted an instructor team that brings genuine professionalism and engagement to the curriculum. The studio is efficiently run with a wide schedule window and a membership structure that makes regular attendance financially manageable. For practitioners in the Park Cities and Preston Hollow corridor who want reliable, high-quality group reformer without committing to the expense of a private studio, this is the most practical and consistently satisfying option.",
    address: "—",
    bestFor: "Consistent reformer programming, memberships, Park Cities convenience",
    signatureClass: "Flow",
    bookingTip: "Monthly memberships are the most financially efficient option for practitioners attending 3+ times per week; the intro offer is worth exhausting",
  },
  {
    number: "05",
    name: "Lakewood Pilates",
    neighborhood: "Lakewood / East Dallas",
    priceLevel: "$$$",
    review: "Lakewood Pilates serves East Dallas's most active and community-minded residential neighbourhood with a programme that takes the method's intelligence as its starting point and builds from there. The studio has cultivated a loyal community of practitioners who have been training here for years — an indicator of sustained quality that is more reliable than any marketing claim. The instruction team is well-trained and particularly strong in its work with intermediate practitioners who want to develop beyond the beginner reformer format and move toward a more sophisticated understanding of the method. Lakewood's characterful, independently minded community has produced a studio that reflects similar values: no-nonsense about the quality of the work, unpretentious about how it presents itself, and genuinely invested in each client's progress.",
    address: "—",
    bestFor: "Intermediate to advanced, community regulars, East Dallas",
    signatureClass: "Reformer Intermediate",
    bookingTip: "The studio's loyal community means availability can tighten; joining the waitlist for standing bookings is worth doing early",
  },
  {
    number: "06",
    name: "Deep Ellum Movement Lab",
    neighborhood: "Deep Ellum",
    priceLevel: "$$",
    review: "Deep Ellum Movement Lab brings Pilates to one of Dallas's most creatively concentrated neighbourhoods at pricing that reflects the area's diverse economic profile. The studio is the most interesting independent practice in East Dallas — informed by the neighbourhood's arts and music culture, genuinely curious about the boundaries of movement practice, and instructed by teachers who bring cross-disciplinary backgrounds spanning dance, somatics, and functional movement therapy. The Deep Ellum clientele is creative and unconventional, and the studio serves this community with both classical reformer and more experimental mat and apparatus work that takes the method seriously without being reverent about its presentation. An excellent option for practitioners who find standard boutique formats aesthetically limiting.",
    address: "—",
    bestFor: "Creative community, movement education, accessible pricing",
    signatureClass: "Reformer & Movement Lab",
    bookingTip: "Drop-in rates are among the most accessible in Dallas; the monthly pass offers strong value in one of the city's most interesting movement communities",
  },
];
