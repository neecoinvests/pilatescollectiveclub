  ...
  "@graph": [
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Melbourne", "item": "https://pilatescollectiveclub.com/cities/melbourne" },
      ],
    },
    {
      "@type": "ItemList",
...
export default function MelbournePage() {
  return (
    <>
      ...
      <Header />
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Studio Guides", href: "/cities" }, { label: "Melbourne (2026)" }]} />
      <main>
