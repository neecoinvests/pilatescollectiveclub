  ...
  "@graph": [
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Zurich", "item": "https://pilatescollectiveclub.com/cities/zurich" },
      ],
    },
    {
      "@type": "ItemList",
...
export default function ZurichPage() {
  return (
    <>
      ...
      <Header />
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Studio Guides", href: "/cities" }, { label: "Zurich" }]} />
      <main>
        {/* Article Header */}
        <section
