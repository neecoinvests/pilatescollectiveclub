  ...
  "@graph": [
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "New York", "item": "https://pilatescollectiveclub.com/cities/new-york" },
      ],
    },
    {
      "@type": "ItemList",
...
export default function NewYorkPage() {
  return (
    <>
      ...
      <Header />
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Studio Guides", href: "/cities" }, { label: "New York City" }]} />
      <main>
