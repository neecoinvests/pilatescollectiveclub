...
const STUDIOS = [
  {
    number: "01",
    name: "Pilates on Fifth",
    neighborhood: "Midtown / Fifth Avenue",
    priceLevel: "$$$",
    review: "Pilates on Fifth is one of New York's most established and respected studios — a Midtown institution that has been training serious practitioners since the 1990s. The instruction here is grounded in the classical method, delivered by teachers with long lineages and deep training. The studio's reputation draws clients from across the city, including professional dancers, athletes, and executives who rely on Pilates as the foundation of their physical practice. The atmosphere is professional and focused without being unwelcoming.",
    address: "200 Fifth Avenue, New York, NY 10010",
    bestFor: "Classical method, serious practitioners, long-term progression",
    signatureClass: "Classical Reformer",
    bookingTip: "Private sessions with senior teachers book weeks in advance. Use their online portal and add yourself to the waitlist — cancellations come through regularly.",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    priceLevel: "$$",
    review: "Core Pilates NYC has built a loyal Upper West Side following through consistent, intelligent teaching and a genuinely welcoming community. The studio is unpretentious and effective — not trying to be the most design-forward room in the city, but reliably delivering excellent instruction across its reformer and mat programme. The teachers here are engaged, communicative, and unusually good at meeting clients at their level. One of the best value propositions in NYC reformer Pilates.",
    address: "2525 Broadway, New York, NY 10025",
    bestFor: "Community, value, accessible quality instruction",
    signatureClass: "Reformer Fundamentals",
    bookingTip: "Monthly membership brings the per-class cost down significantly. The Saturday morning classes have a cult following — book them on Monday.",
  },
  {
    number: "04",
...
const FURTHER_READING = [
  { title: "The Beginner's Guide to Reformer Pilates", excerpt: "What to expect in your first reformer class and how to choose a studio.", href: "/blog/beginners-guide-to-reformer-pilates", category: "Beginner Guide", readTime: "8 min read", date: "May 2026" },
        ...
        <section className="px-6 mb-16">
          <div className="max-w-5xl mx-auto">
            <div className="w-full rounded-2xl overflow-hidden relative" style={{ height: "420px" }}>
              <Image src="https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?auto=format&fit=crop&w=1400&q=80" alt="New York City skyline" fill className="object-cover" style={{ filter: "brightness(0.88)" }} />
