...
export const metadata: Metadata = {
  title: "Best Pilates Studios in Milan (2026) | Pilates Collective Club",
  description:
  ...
  "@graph": [
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Milan", "item": "https://pilatescollectiveclub.com/cities/milan" },
      ],
    },
    {
      "@type": "ItemList",
...
export default function MilanPage() {
  return (
    <>
      ...
      <Header />
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Studio Guides", href: "/cities" }, { label: "Milan (2026)" }]} />
      <main>
