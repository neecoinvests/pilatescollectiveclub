...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://images.unsplash.com/photo-1518756131217-31eb79b20e8f?w=1200&q=80", width: 1200, height: 630, alt: "Boston Massachusetts city guide — Pilates Collective Club" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "The Best Pilates Studios in Boston, MA (2026)",
    description: "Six curated Pilates studios in Boston — verified picks for every level.",
    images: ["https://images.unsplash.com/photo-1518756131217-31eb79b20e8f?w=1200&q=80"],
  },
  alternates: {
        ...
        <section className="px-6 mb-16">
          <div className="max-w-5xl mx-auto">
            <div className="pcc-city-hero-image w-full rounded-2xl overflow-hidden relative" style={{ height: "420px" }}>
              <Image src="https://images.unsplash.com/photo-1518756131217-31eb79b20e8f?w=1400&q=80" alt="Boston Massachusetts skyline" fill className="object-cover" style={{ filter: "brightness(0.88)" }} />
