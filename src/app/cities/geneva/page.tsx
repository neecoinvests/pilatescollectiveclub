  ...
  "@graph": [
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Geneva", "item": "https://pilatescollectiveclub.com/cities/geneva" },
      ],
    },
    {
      "@type": "ItemList",
...
export default function GenevaPage() {
  return (
    <>
      ...
      <Header />
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Studio Guides", href: "/cities" }, { label: "Geneva" }]} />
      <main>
