...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b?w=1200&h=630&fit=crop",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      "https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b?w=1200&h=630&fit=crop",
    ],
  },
  alternates: {
...
const STUDIOS = [
  {
    number: "1",
    name: "Vegas Pilates Collective",
    neighborhood: "Summerlin",
    priceLevel: "$$$",
    review:
      "Vegas Pilates Collective is the standout upscale reformer studio in Summerlin's master-planned western suburbs. The space is immaculate — 20 Balanced Body reformers arranged beneath skylights that flood the room with Nevada's abundant natural light, without the desert heat. Instructors hold dual certifications in both contemporary and classical methods, and the studio's tiered programming ensures clients move through a logical progression rather than repeating the same class indefinitely. The community here skews toward health-conscious professionals and serious movers who want results alongside a high-end environment.",
    address: "—",
    bestFor: "Dedicated reformer enthusiasts seeking structured progression in a luxury setting",
    signatureClass: "Foundation Reformer Series",
    bookingTip: "The Foundation Series sells out within hours of opening — enable app notifications and book the moment spots release.",
  },
  {
    number: "2",
    name: "The Pilates Room Las Vegas",
    neighborhood: "Henderson",
    priceLevel: "$$$",
    review:
      "Henderson's premier classical Pilates studio occupies a purpose-built space that houses authentic Gratz apparatus alongside Pilates Arc, Cadillac, and Wunda Chair. Teachers here trained through recognized classical lineages and adhere closely to the original Pilates method — expect the traditional order, precise spring tensions, and uncompromising attention to form. The studio draws a loyal clientele of long-term practitioners who've moved on from trendy reformer classes and want the full apparatus experience. Quietly serious and exceptionally well-run.",
    address: "—",
    bestFor: "Classical Pilates purists and those seeking full apparatus work",
    signatureClass: "Classical Apparatus & Mat",
    bookingTip: "Private and duet sessions book two to three weeks out — reserve as soon as your schedule is confirmed.",
  },
  {
    number: "3",
    name: "Arts District Movement",
    neighborhood: "Downtown Arts District",
    priceLevel: "$$",
    review:
      "In the heart of Las Vegas's creative 18b Arts District, Arts District Movement brings a refreshingly independent spirit to reformer Pilates. The studio's exposed brick walls, rotating local artwork, and inclusive programming set it apart from the polished franchise experience. Classes blend contemporary reformer technique with functional movement and breath work, attracting a diverse crowd of artists, hospitality workers, and wellness newcomers. Weekend community classes and pop-up workshops on topics from pre-natal Pilates to postural health add depth to the schedule.",
    address: "—",
    bestFor: "Beginners and movers who value community, creativity, and accessible pricing",
    signatureClass: "Reformer Fusion",
    bookingTip: "Weekend reformer spots open Sunday evening — set a reminder and book immediately.",
  },
  {
    number: "4",
    ...
    priceLevel: "$$",
    review:
      "The Summerlin outpost of this well-known national brand delivers exactly what Las Vegas's busy suburban professionals need: reliable class formats, consistent instruction, and unlimited-class membership tiers that reward frequent attendance. Twelve reformers, clean facilities, and instructors who prioritize safety and proper cueing make this a solid choice for anyone practicing three or more times per week. It won't surprise you — and for many clients, that predictability is precisely the point. A trustworthy franchise option in one of the city's most family-friendly neighborhoods.",
    address: "—",
  ...
  {
    number: "5",
    name: "Spring Valley Pilates",
    neighborhood: "Spring Valley",
    priceLevel: "$$$",
    review:
      "Spring Valley Pilates is a boutique reformer studio that punches well above its size. With just eight reformers, every class is genuinely intimate — instructors know clients by name, track their progression, and adjust programming session by session. The lead instructor's background in dance brings exceptional body awareness to the cuing, and the studio's focus on alignment and core integration produces results that clients notice quickly. The Spring Valley location is convenient for those living between the Strip corridor and Summerlin, offering a quieter alternative to busier parts of the city.",
    address: "—",
    bestFor: "Intermediate to advanced practitioners who want close, personalized instructor attention",
    signatureClass: "Boutique Reformer Intensive",
    bookingTip: "Eight-reformer capacity makes this one of the hardest studios to book — join the waitlist immediately when a class fills.",
  },
  {
    number: "6",
    name: "Henderson Pilates & Wellness",
    neighborhood: "Henderson",
    priceLevel: "$$",
    review:
      "Henderson Pilates & Wellness leads with a therapeutic philosophy, making it an excellent choice for anyone managing back pain, recovering from injury, or seeking movement that supports long-term joint health. The lead instructor holds an advanced certification in therapeutic Pilates alongside training in fascial release and corrective movement. Classes are smaller than average, and every new client receives an intake consultation before stepping onto a reformer. Paired with regular workshops on posture, breathing mechanics, and movement nutrition, this studio treats Pilates as medicine — and delivers accordingly.",
    address: "—",
    bestFor: "Therapeutic Pilates and rehabilitation-focused clients",
    signatureClass: "Therapeutic Reformer & Mat",
    bookingTip: "Request the complimentary intake consultation before your first class — it shapes every subsequent session.",
  },
];
      ...
      <main>
        ...
        <section className="px-6 mb-16">
          <div className="max-w-5xl mx-auto relative rounded-2xl overflow-hidden" style={{ height: "420px" }}>
            <Image
              src="https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b?w=1400&h=840&fit=crop"
              alt="Pilates studio in Las Vegas, NV"
              fill
