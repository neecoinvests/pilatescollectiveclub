...
const STUDIOS = [
  {
    number: "01",
    name: "Basi Pilates Tokyo — Minami-Aoyama",
    neighborhood: "Minami-Aoyama",
    priceLevel: "$$$",
    review: "The Tokyo outpost of the internationally respected Basi Pilates network is one of the finest Pilates addresses in Japan. Situated on a quiet lane in Minami-Aoyama, the studio's interiors reflect the neighbourhood's refined aesthetic — clean lines, exceptional equipment, and a curriculum rooted in Rael Isacowitz's celebrated contemporary method. Instructors here hold Basi certifications and bring a depth of anatomical knowledge that distinguishes the studio from its competitors. Both private and duet sessions are available, with group reformer classes running throughout the day.",
    address: "3-12-8 Minami-Aoyama, Minato-ku, Tokyo",
    bestFor: "Basi method, technically rigorous instruction, Aoyama professionals",
    signatureClass: "Basi Reformer Level II",
    bookingTip: "Book via their website at least a week ahead for evening sessions. The studio has a strict 24-hour cancellation policy — late cancellations forfeit the full class fee, which is standard across Tokyo's premium studios.",
  },
  {
    number: "02",
    name: "Movement Arts Tokyo",
    neighborhood: "Ebisu",
    priceLevel: "$$$",
    review: "Movement Arts Tokyo occupies a beautifully converted second-floor space in Ebisu and has built a devoted following among the neighbourhood's international creative community. The studio blends classical Pilates with elements of Gyrotonic and somatic movement — the result is a practice that feels genuinely exploratory rather than prescriptive. Lead instructor Yuki Tanaka trained in New York and London and brings an unusually articulate teaching style that makes complex movement concepts accessible across language barriers. English and Japanese instruction are both available.",
    address: "2-14-5 Ebisu-Nishi, Shibuya-ku, Tokyo",
    bestFor: "Bilingual instruction, Gyrotonic integration, creative professionals",
    signatureClass: "Integrated Movement Flow",
    bookingTip: "English-language sessions are specifically noted in the online schedule — filter by language when booking if you're not comfortable in Japanese. The Wednesday 7pm English group class fills particularly fast.",
  },
  {
    number: "03",
    name: "Studio C Pilates",
    neighborhood: "Daikanyama",
    priceLevel: "$$",
    review: "Studio C has become one of Daikanyama's most beloved wellness addresses — a small, owner-operated studio with a warm atmosphere that contrasts pleasingly with the area's more fashion-forward businesses. The teaching here leans classical, with an emphasis on breath, precision, and the kind of patient progression that serious Pilates practitioners seek out. Class sizes are capped at five, which means the quality of instruction is genuinely personalised. The studio also offers one of the more accessible price points in this part of Tokyo without any compromise on equipment quality.",
    address: "17-6 Daikanyama-cho, Shibuya-ku, Tokyo",
    bestFor: "Small-group classical Pilates, value pricing, Daikanyama community",
    signatureClass: "Studio C Classical Reformer",
    bookingTip: "The studio uses a simple booking form on their website — no app required. Slots open two weeks in advance. The Friday morning class has a waitlist most weeks; add yourself as soon as the week opens.",
  },
  {
    number: "04",
    name: "Zen Place Pilates — Shinjuku",
    neighborhood: "Shinjuku",
    priceLevel: "$$",
    review: "Zen Place is Japan's most extensive Pilates network, and the Shinjuku location is one of their strongest. The studio is efficient by necessity — Tokyo real estate demands it — but the programming is excellent and the instructor training is consistently rigorous. Zen Place's group reformer classes run to a structured 50-minute format that suits the city's time-pressed professional class. The Shinjuku location's central position means it's easily accessible from most of the city, making it a practical choice for practitioners who commute from multiple districts.",
    address: "4-1-7 Shinjuku, Shinjuku-ku, Tokyo",
    bestFor: "Accessibility, consistent quality, central location",
    signatureClass: "Zen Place Reformer Standard",
    bookingTip: "Zen Place's app allows booking across all Tokyo locations — useful if you want to supplement Shinjuku sessions with other venues. Monthly membership packages offer significant per-class savings for practitioners attending three or more times per week.",
  },
  {
    number: "05",
    name: "Pilates Haus",
    ...
    priceLevel: "$$$",
    review: "Pilates Haus occupies a discreet townhouse in Nishi-Azabu, operating with the kind of quiet excellence that characterises the best of Tokyo's private wellness scene. The studio works exclusively in private and semi-private sessions — no group classes — ensuring that each client receives undivided instructor attention throughout. The equipment room houses a full Gratz apparatus alongside contemporary Balanced Body reformers, and the teaching team's breadth of training is exceptional. For those who value privacy and precision above all else, Pilates Haus is the definitive Tokyo address.",
    address: "3-8-12 Nishi-Azabu, Minato-ku, Tokyo",
    bestFor: "Private sessions only, full apparatus, Gratz equipment",
    signatureClass: "Full Apparatus Private Session",
    bookingTip: "New clients must complete a complimentary intake assessment before booking their first full session. Email the studio directly — their English correspondence is excellent. Sessions book out two to three weeks in advance.",
  },
];
  ...
  "@graph": [
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Tokyo", "item": "https://pilatescollectiveclub.com/cities/tokyo" },
      ],
    },
    {
      "@type": "ItemList",
...
export default function TokyoPage() {
  return (
    <>
      ...
      <Header />
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Studio Guides", href: "/cities" }, { label: "Tokyo (2026)" }]} />
      <main>
