...
const STUDIOS = [
  {
    number: "1",
    name: "Hyde Park Pilates",
    neighborhood: "Hyde Park",
    priceLevel: "$$$",
    review:
      "Hyde Park Pilates is South Tampa's most polished reformer destination, housed in a light-filled studio just steps from Bayshore Boulevard. Sixteen Balanced Body reformers are arranged beneath high ceilings, and the instructor roster reads like a who's-who of Tampa's fitness community — all holding advanced certifications and bringing genuine teaching depth. Programming is tiered from Foundation through Advanced, ensuring clients progress systematically. The clientele skews professional and the atmosphere is quietly luxurious — towel service, cold eucalyptus towels post-class, and a lobby stocked with the kind of recovery snacks that actually taste good.",
    address: "—",
    bestFor: "Upscale reformer experience with structured progression tracks",
    signatureClass: "Hyde Park Reformer Intensive",
    bookingTip: "Foundation spots open Monday at 8 AM and are gone by noon — set an alert.",
  },
  {
    number: "2",
    name: "South Tampa Pilates",
    neighborhood: "South Tampa",
    priceLevel: "$$$",
    review:
      "South Tampa Pilates is the area's home for classical methodology, operating out of a beautifully appointed studio with authentic apparatus and instructors trained through recognized classical lineages. The teaching here is deliberate and precise — original Pilates choreography, correct sequencing, and an emphasis on breath and form over speed. If you've spent years in contemporary group reformer classes and want to understand what Joseph Pilates actually intended, this is where to go. Private and duet sessions are the studio's core offering, though mat classes run several times weekly.",
    address: "—",
    bestFor: "Classical Pilates purists and post-rehabilitation clients",
    signatureClass: "Classical Mat & Full Apparatus",
    bookingTip: "Private sessions book two to three weeks out — call directly rather than using the online portal.",
  },
  {
    number: "3",
    name: "Seminole Heights Movement",
    neighborhood: "Seminole Heights",
    priceLevel: "$$",
    review:
      "Seminole Heights Movement embodies everything that makes its neighborhood special: independent, community-driven, and refreshingly free of pretension. The studio occupies a converted bungalow with warm wood floors and local art on the walls, and the six-reformer setup keeps classes genuinely intimate. Instructors blend classical mat fundamentals with contemporary reformer programming, and the weekly schedule includes themed workshops on topics from postural assessment to Pilates for runners. The price point is among the most accessible in Tampa, and the sense of belonging you feel after just a few classes is rare.",
    address: "—",
    bestFor: "Beginners and community-focused movers seeking real instructor attention",
    signatureClass: "Heights Reformer & Mat Flow",
    bookingTip: "Saturday morning classes are the neighborhood social event — book Friday or expect the waitlist.",
  },
  {
    number: "4",
    ...
    priceLevel: "$$",
    review:
      "The Westchase location of this national brand is one of Tampa Bay's busiest, serving the area's dense population of professionals and young families with a consistent, well-run reformer program. Ten reformers, predictable class formats, and flexible membership tiers make it the practical choice for clients who want to practice three or four times a week without stretching their budget. Instructors are thorough with safety cues and attentive to form corrections. Not the place for experimental programming, but an excellent base for building a regular Pilates habit — and the extended hours accommodate early risers and late-evening sessions alike.",
    address: "—",
  ...
  },
  {
    ...
    priceLevel: "$$$",
    review:
      "Across the bay in St. Petersburg, this studio has built one of the strongest reformer reputations in the entire Tampa Bay region. The space is striking — warehouse ceilings, coastal light, and fourteen Balanced Body reformers arranged for maximum airflow, a genuine consideration in Florida's climate. The instructor team leans heavily toward therapeutic and sport-specific programming, making it the destination of choice for serious athletes, dancers, and clients managing complex injuries. The commute from Tampa proper is worth it: the caliber of teaching here is simply a level above most of what you'll find on the Tampa side.",
    address: "—",
    bestFor: "Athletes, dancers, and clients seeking therapeutic reformer expertise",
    signatureClass: "Sport Reformer & Cadillac",
    bookingTip: "Book online — the studio's reputation means drop-ins are rarely available without advance reservation.",
  },
  {
    number: "6",
    name: "Ybor City Studio",
    neighborhood: "Ybor City",
    priceLevel: "$$",
    review:
      "Ybor City Studio brings the arts-district energy of Tampa's most historic neighborhood into a movement space that genuinely feels alive. The exposed brick, Cuban-tile accents, and curated soundtrack create an atmosphere unlike any other Pilates studio in the city. Programming covers reformer and mat fundamentals, but the studio also runs fusion formats that incorporate elements of dance conditioning and breathwork — reflecting the creative influences of the neighborhood. Weekend evening classes draw a younger, more eclectic crowd, and the community events calendar keeps the studio connected to Ybor's broader cultural scene.",
    address: "—",
    bestFor: "Creative movers who want atmosphere and community alongside their Pilates",
    signatureClass: "Ybor Reformer Fusion",
    bookingTip: "Weekend evening classes open Wednesday — the studio's social following is large, so don't delay.",
  },
];
