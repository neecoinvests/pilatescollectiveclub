...
const STUDIOS = [
  {
    number: "01",
    name: "Club Pilates Pearl District",
    neighborhood: "Pearl District",
    priceLevel: "$$$",
    review: "Club Pilates Pearl District is one of Portland's top-rated reformer studios, consistently earning five-star reviews for instructor quality and the warm, design-forward atmosphere that fits the Pearl's character. The studio draws professionals, architects, and design-community regulars from across Portland's most walkable neighborhood. The schedule is dense and well-organized, and instructors are praised for their attentive cueing in both beginner and advanced class formats. One of the city's most reliably excellent reformer options.",
    address: "915 NW Davis St, Portland, OR 97209",
    bestFor: "Pearl District community, all levels, contemporary reformer",
    signatureClass: "Reformer Flow",
    bookingTip: "Morning and lunchtime classes fill mid-week — book 4–5 days ahead for consistent access.",
  },
  {
    number: "02",
    name: "Yoga Pearl / Pilates at Yoga Pearl",
    neighborhood: "Pearl District / NW Portland",
    priceLevel: "$$$",
    review: "Yoga Pearl is one of Portland's most beloved and long-running movement studios, offering a dedicated Pilates program alongside its flagship yoga schedule. The Pearl District location is beautifully appointed, centrally located, and staffed by instructors who bring genuine depth to their reformer and mat teaching. The studio's community is loyal and multigenerational, reflecting the Pearl's diverse residential and professional population. Pilates classes here are small, thoughtful, and appropriately challenging across levels.",
    address: "925 NW Davis St, Portland, OR 97209",
    bestFor: "Mixed movement practice, Pearl District community, all levels",
    signatureClass: "Reformer & Mat",
    bookingTip: "Reserve weekend morning spots by Thursday — they fill consistently with the Pearl's active residential population.",
  },
  {
    number: "03",
    name: "Club Pilates Sellwood",
    neighborhood: "Sellwood-Moreland",
    priceLevel: "$$$",
    review: "Club Pilates Sellwood serves one of Portland's most family-oriented and health-conscious residential neighborhoods with consistent, well-structured reformer programming. The studio has built a loyal community of regulars from Sellwood, Moreland, and the surrounding south Portland neighborhoods who appreciate both the instruction quality and the genuinely warm atmosphere. Instructors receive consistent praise for their patience with new clients and attentiveness to alignment throughout class.",
    address: "8001 SE 13th Ave, Portland, OR 97202",
    bestFor: "South Portland residents, all levels, neighborhood community",
    signatureClass: "Reformer Essentials",
    bookingTip: "Weekday evening classes are popular with the residential commuter demographic — book 5–6 days ahead.",
  },
  {
    number: "04",
    ...
    priceLevel: "$$$",
    review: "Club Pilates Beaverton serves the Portland metro's largest suburban employment corridor — Nike, Intel, and the Washington Square corridor — with a reformer program that is consistent, well-delivered, and practical for the west side's professional population. The studio benefits from a well-trained instructor team and a schedule dense enough to accommodate demanding work patterns. Membership pricing makes regular attendance financially accessible. The most practical reformer option for west-side practitioners.",
    address: "4945 SW Griffith Dr, Beaverton, OR 97005",
    bestFor: "West-side residents and professionals, memberships, consistent reformer",
    signatureClass: "Flow",
    bookingTip: "Lunchtime slots are popular with Nike and Intel campus workers — book early in the week for midday access.",
  },
  {
    number: "05",
    name: "Club Pilates Lake Oswego",
    neighborhood: "Lake Oswego",
    priceLevel: "$$$",
    review: "Club Pilates Lake Oswego serves the Portland metro's most affluent and health-invested suburb with a franchise reformer program that consistently meets the community's high expectations. The studio is clean, professionally run, and staffed by instructors who bring genuine engagement to the curriculum. Lake Oswego's active community — cyclists, rowers, hikers — uses Pilates as a year-round complement to their outdoor activities, and the instructors are well-versed in sport-specific programming.",
    address: "502 Second St, Lake Oswego, OR 97034",
    bestFor: "Lake Oswego and south metro residents, athletic cross-training, memberships",
    signatureClass: "Reformer 1.5",
    bookingTip: "The 8-session class pack is the best value for practitioners attending semi-regularly — great intro to the studio before committing to a membership.",
  },
  {
    number: "06",
    name: "Club Pilates SE Portland",
    neighborhood: "SE Portland / Division",
    priceLevel: "$$",
    review: "Club Pilates SE Portland brings accessible, quality reformer programming to one of Portland's most vibrant commercial and residential corridors. The Division Street–adjacent location serves the neighborhood's mix of longtime Portlanders, young families, and creatives with a welcoming, no-pretension atmosphere and honest membership pricing. Instructors are praised for their warmth with beginners and their clear cueing throughout class. One of Portland's most accessible entry points into regular reformer practice.",
    address: "3556 SE Division St, Portland, OR 97202",
    bestFor: "Beginners, SE Portland community, accessible pricing",
    signatureClass: "Reformer Foundations",
    bookingTip: "Drop-in rates are among the most accessible in Portland — great for sampling before committing to a membership.",
  },
];
...
const FURTHER_READING = [
  { title: "Pilates for Athletes", excerpt: "How elite sports professionals use Pilates to build functional strength, prevent injury, and extend their careers.", href: "/blog/pilates-for-athletes", category: "Performance", readTime: "7 min read", date: "June 2026", imageUrl: "https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?w=1200&q=80" },
  { title: "How to Build a Consistent Pilates Practice", excerpt: "The habits, scheduling strategies, and mindset shifts that separate occasional students from committed practitioners.", href: "/blog/how-to-build-a-consistent-pilates-practice", category: "Guide", readTime: "7 min read", date: "June 2026", imageUrl: "https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?w=1200&q=80" },
];
