        ...
        <section className="px-6 mb-16">
          <div className="max-w-5xl mx-auto">
            <div className="pcc-city-hero-image w-full rounded-2xl overflow-hidden relative" style={{ height: "420px" }}>
              <Image src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Portland_skyline_from_Pittock_Mansion_May_2021_cropped.jpg/1200px-Portland_skyline_from_Pittock_Mansion_May_2021_cropped.jpg" alt="Portland Oregon" fill unoptimized className="object-cover" style={{ filter: "brightness(0.88)" }} />
