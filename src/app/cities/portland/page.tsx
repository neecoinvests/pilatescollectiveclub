...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://images.unsplash.com/photo-1507608616759-54f48f0af0ee?w=1200&q=80", width: 1200, height: 630, alt: "Portland Oregon city guide — Pilates Collective Club" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "The Best Pilates Studios in Portland, OR (2026)",
    description: "Six curated Pilates studios in Portland — verified picks for every level.",
    images: ["https://images.unsplash.com/photo-1507608616759-54f48f0af0ee?w=1200&q=80"],
  },
        ...
        <section className="px-6 mb-16">
          <div className="max-w-5xl mx-auto">
            <div className="pcc-city-hero-image w-full rounded-2xl overflow-hidden relative" style={{ height: "420px" }}>
              <Image src="https://images.unsplash.com/photo-1507608616759-54f48f0af0ee?w=1400&q=80" alt="Portland Oregon" fill className="object-cover" style={{ filter: "brightness(0.88)" }} />
