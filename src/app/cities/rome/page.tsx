  ...
  "@graph": [
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Rome", "item": "https://pilatescollectiveclub.com/cities/rome" },
      ],
    },
    {
      "@type": "ItemList",
...
export default function RomePage() {
  return (
    <>
      ...
      <Header />
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Studio Guides", href: "/cities" }, { label: "Rome (2026)" }]} />
      <main>
