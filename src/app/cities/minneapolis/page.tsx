...
const STUDIOS = [
  {
    number: "01",
    name: "Minneapolis Pilates Center",
    neighborhood: "Linden Hills",
    priceLevel: "$$$$",
    review: "Minneapolis Pilates Center in Linden Hills is the Twin Cities' most respected classical studio — a practice built on deep method knowledge and a commitment to the Pilates apparatus that predates the boutique reformer market by years. The Linden Hills location is fitting: a wealthy, educated residential neighbourhood with the health literacy and patience to appreciate what a lineage-connected classical studio offers versus its contemporary competitors. The teaching draws on the full apparatus suite — Reformer, Cadillac, Wunda Chair, Ladder Barrel — with sequencing intelligence that reflects genuine mastery of the method's progression system. Private and semi-private sessions are the primary format, and the instructor team is among the most thoroughly trained working in Minnesota. For Minneapolis practitioners who have outgrown group reformer and want to understand what Pilates actually is at its deepest level, this is the obvious first address.",
    address: "—",
    bestFor: "Classical full apparatus, advanced practitioners, serious beginners",
    signatureClass: "Classical Reformer & Cadillac",
    bookingTip: "New clients should complete the intake process before booking; instructor waitlists move slowly — the patience is rewarded",
  },
  {
    number: "02",
    name: "Uptown Pilates Minneapolis",
    neighborhood: "Uptown",
    priceLevel: "$$$",
    review: "Uptown Pilates has become Minneapolis's most commercially successful independent reformer studio — a practice that has managed to serve the neighbourhood's demanding, health-literate population without sacrificing instructional quality for volume. The reformer programme is contemporary and athletic, with class sequencing that builds genuine functional strength and respects the Pilates method's foundational intelligence simultaneously. Uptown's mix of young professionals, artists, and wellness-first residents has given the studio a community that holds its standards high and rewards the teaching team when those standards are consistently met. The studio is particularly strong in its intermediate and advanced offerings, which are more physically and technically demanding than those of most Minneapolis competitors. One of the most reliable good-session guarantees in the Twin Cities.",
    address: "—",
    bestFor: "Contemporary reformer, intermediate to advanced, Uptown community",
    signatureClass: "Dynamic Reformer",
    bookingTip: "Weekend morning classes fill early in the week; book by Tuesday for Saturday and Sunday prime slots",
  },
  {
    number: "03",
    name: "NE Minneapolis Movement",
    neighborhood: "Northeast Minneapolis",
    priceLevel: "$$$",
    review: "NE Minneapolis Movement serves the city's most creatively vibrant and rapidly evolving neighbourhood with a Pilates programme that matches Northeast's energy: intelligent, community-oriented, and serious about the work without being precious about its presentation. The studio has built a strong community of regulars drawn from the artists, designers, and young professionals who have made Northeast one of Minneapolis's most interesting places to live and work. The reformer programme is well-taught and progressively structured, with instructors who bring both technical training and genuine enthusiasm for the method's capacity to change the body over time. Northeast's independent-minded community has found in this studio a practice that reflects its values — quality without pretension, depth without exclusivity.",
    address: "—",
    bestFor: "All levels, NE Minneapolis community, progressive reformer",
    signatureClass: "Reformer Flow",
    bookingTip: "Evening classes are popular with the creative workforce; book at least 5 days ahead for weeknight prime slots",
  },
  {
    number: "04",
    ...
    priceLevel: "$$$",
    review: "Club Pilates Eden Prairie serves the affluent southwest Twin Cities suburban corridor — Eden Prairie, Edina, and Minnetonka — with a franchise reformer programme that is among the most consistently well-delivered in the Minnesota market. The southwest metro demographic has the wellness awareness and financial resources to support a high-quality franchise offering, and the studio has attracted an instructor team that brings genuine professionalism to the Club Pilates curriculum. The schedule is dense enough to accommodate the flexible working patterns of the area's professional population, and the membership structure makes regular attendance financially accessible for practitioners looking to build a 2–3 times weekly habit. A reliable, well-managed option for southwest metro practitioners who want quality reformer without the Uptown commute.",
    address: "—",
    bestFor: "Consistent reformer programming, memberships, southwest suburb convenience",
    signatureClass: "Flow",
    bookingTip: "Monthly memberships cut per-class costs significantly; the intro offer covers enough session types to inform a clear membership decision",
  },
  {
    number: "05",
    name: "St Paul Pilates",
    neighborhood: "Grand Avenue, St Paul",
    priceLevel: "$$$",
    review: "St Paul Pilates on Grand Avenue serves the Minnesota capital's most pleasant and health-invested residential corridor with a reformer programme that reflects St Paul's quieter, more considered character relative to its larger twin city. The studio is serious without being intimidating, and the instruction team takes the work — and each client's individual progress — genuinely seriously. Grand Avenue's professional and family population has given St Paul Pilates a loyal community of long-term practitioners who value the continuity and individual attention that a well-run neighbourhood studio provides. The studio's particular strength is its ability to work with a genuinely mixed-ability client base — developing beginners and challenging advanced practitioners in the same session through clear cuing and well-judged individual modification.",
    address: "—",
    bestFor: "All levels, St Paul convenience, Grand Avenue community",
    signatureClass: "Reformer Essentials",
    bookingTip: "Grand Avenue parking is manageable outside peak hours; Saturday morning is the studio's most popular session — book by Wednesday",
  },
  {
    number: "06",
    name: "Nicollet Island Movement",
    neighborhood: "Downtown / North Loop",
    priceLevel: "$$",
    review: "Nicollet Island Movement is Minneapolis's most accessibly priced quality studio — a practice that has made a deliberate commitment to keeping serious Pilates instruction within reach of practitioners who cannot or will not pay Linden Hills prices. The studio serves Downtown and North Loop residents and workers with a programme that combines mat and reformer work in a teaching environment that is welcoming to beginners without being condescending to experienced practitioners. The North Loop neighbourhood's mix of young professionals, transplants, and creative industry workers has created an engaged, diverse community around a practice that feels genuinely inclusive rather than performatively so. For first-time Minneapolis Pilates practitioners, this is often the best starting point — excellent instruction at pricing that allows for regular attendance before committing to a more expensive studio.",
    address: "—",
    bestFor: "Beginners, accessible pricing, Downtown and North Loop",
    signatureClass: "Reformer Fundamentals",
    bookingTip: "Drop-in rates are among the fairest in Minneapolis; the monthly unlimited pass is particularly strong value for Downtown residents",
  },
];
