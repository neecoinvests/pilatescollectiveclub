...
const STUDIOS = [
  {
    ...
    bookingTip: "Teacher training alumni often offer discounted privates — worth asking at reception",
  },
  {
    number: "02",
    name: "Iso Fit",
    ...
    bookingTip: "Waitlist for preferred instructors can run to several weeks — enquire well in advance",
  },
  {
    number: "03",
  ...
  },
  {
    ...
    bookingTip: "Wong Chuk Hang MTR exit C is a five-minute walk; avoid driving during gallery opening nights",
  },
  {
    number: "05",
    name: "Defin8 Fitness",
    ...
    bookingTip: "Monthly class packs offer strong value; introductory offers available for first-time clients",
  },
  {
    number: "06",
    name: "HANN Pilates",
    ...
    bookingTip: "Evening classes fill quickly among office-to-studio commuters; book mornings for more flexibility",
  }
];
