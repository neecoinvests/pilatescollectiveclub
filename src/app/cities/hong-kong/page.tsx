...
const STUDIOS = [
  {
    ...
    priceLevel: "HK$$$$",
    review: "4.9 · 780+ reviews",
    address: "19/F, 2 Johnston Rd, Wan Chai, HK",
    bestFor: "Hong Kong's most awarded Pilates studio",
    signatureClass: "FLEX Reformer Advanced",
    bookingTip: "Online booking essential; cancellations charged",
  },
  {
    number: "02",
    name: "Iso Fit",
    ...
    address: "10/F, Euro Trade Centre, 13 Connaught Rd, Central",
    bestFor: "Functional training & Pilates fusion",
    signatureClass: "Iso Reformer Flow",
    bookingTip: "Early-bird 7am classes popular with finance crowd",
  },
  {
    number: "03",
    ...
    priceLevel: "HK$$$",
    review: "4.8 · 640+ reviews",
    address: "14/F, Shun Tak Centre, 168 Connaught Rd, HK",
    bestFor: "Premium chain with multiple HK locations",
    signatureClass: "ABSOLUTE Reformer Signature",
    bookingTip: "Multi-location membership covers all HK studios",
  },
  {
    number: "04",
    name: "H-Kore",
    ...
    address: "22/F, 8 Wong Chuk Hang Rd, Aberdeen, HK",
    bestFor: "Lagree & reformer in arts district",
    signatureClass: "H-Kore Lagree 45",
    bookingTip: "South-side studio; combine with Aberdeen harbour walk",
  },
  {
    number: "05",
    name: "Defin8 Fitness",
    ...
    address: "G/F, 18 Third St, Sai Ying Pun, HK",
    bestFor: "Boutique reformer near HKU",
    signatureClass: "Defin8 Reformer Circuit",
    bookingTip: "Student discounts available with valid ID",
  },
  {
    number: "06",
    name: "HANN Pilates",
    ...
    address: "12/F, Lockhart Centre, 301 Lockhart Rd, Causeway Bay",
    bestFor: "Contemporary reformer with group energy",
    signatureClass: "HANN Power Reformer",
    bookingTip: "Monthly class pass: 8 classes for HK$1,600",
  }
];
