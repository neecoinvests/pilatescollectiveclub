  ...
  "@graph": [
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Hong Kong", "item": "https://pilatescollectiveclub.com/cities/hong-kong" },
      ],
    },
    {
      "@type": "ItemList",
...
export default function HongKongPage() {
  return (
    <>
      ...
      <Header />
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Studio Guides", href: "/cities" }, { label: "Hong Kong (2026)" }]} />
      <main>
