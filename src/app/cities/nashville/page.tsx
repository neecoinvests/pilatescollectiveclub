...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://images.unsplash.com/photo-rwKwShOn25k?w=1200&q=80", width: 1200, height: 630, alt: "Nashville Tennessee city guide — Pilates Collective Club" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "The Best Pilates Studios in Nashville, TN (2026)",
    description: "Six curated Pilates studios in Nashville — verified picks for every level.",
    images: ["https://images.unsplash.com/photo-rwKwShOn25k?w=1200&q=80"],
  },
  alternates: {
        ...
        <section className="px-6 mb-16">
          <div className="max-w-5xl mx-auto">
            <div className="pcc-city-hero-image w-full rounded-2xl overflow-hidden relative" style={{ height: "420px" }}>
              <Image src="https://images.unsplash.com/photo-rwKwShOn25k?w=1400&q=80" alt="Nashville Tennessee skyline" fill className="object-cover" style={{ filter: "brightness(0.88)" }} />
