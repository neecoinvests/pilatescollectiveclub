        ...
        <section className="px-6 mb-16">
          <div className="max-w-5xl mx-auto">
            <div className="pcc-city-hero-image w-full rounded-2xl overflow-hidden relative" style={{ height: "420px" }}>
              <Image src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Nashville_skyline_from_Fort_Negley_2018.jpg/1200px-Nashville_skyline_from_Fort_Negley_2018.jpg" alt="Nashville Tennessee skyline" fill className="object-cover" style={{ filter: "brightness(0.88)" }} />
