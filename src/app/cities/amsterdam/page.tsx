...
const STUDIOS = [
  {
    number: "01",
    name: "Pilates Studio Amsterdam",
    neighborhood: "Jordaan",
    priceLevel: "€€€",
    review: "Pilates Studio Amsterdam is the city's most established dedicated Pilates space — a Jordaan studio that has quietly maintained excellent standards while the neighbourhood around it transformed into one of Europe's most desirable postcodes. The instruction here is thorough and classical in orientation, delivered by a small team of highly trained teachers. Group classes are capped at eight clients, private sessions are deeply personalised, and the overall experience reflects the understated quality that Amsterdam's finest independent businesses consistently deliver.",
    address: "Prinsengracht 485, 1016 HP Amsterdam",
    bestFor: "Classical method, all levels, intimate atmosphere",
    signatureClass: "Reformer & Tower",
    bookingTip: "Book at least three days ahead for morning sessions. The studio's loyal regulars tend to hold recurring slots — cancellations are your best route to prime times.",
  },
  {
    number: "02",
    name: "Reform Studio Amsterdam",
    neighborhood: "De Pijp",
    priceLevel: "€€",
    review: "Reform Studio has become one of Amsterdam's most talked-about fitness destinations since opening in De Pijp — a neighbourhood that attracts a young, international, health-conscious crowd who have made the studio their daily ritual. The instruction is contemporary and energetic, with a clear focus on the reformer and a programme that scales intelligently from beginner to advanced levels. The studio's community feel is genuine and warm, and the pricing is notably more accessible than the premium studios north of the river.",
    address: "Van Woustraat 76, 1073 LP Amsterdam",
    bestFor: "Contemporary reformer, young professional crowd, community",
    signatureClass: "Reform Flow 50",
    bookingTip: "The intro three-class package is excellent value. Evening classes book fastest — reserve them by Tuesday for the following week.",
  },
  {
    number: "03",
  ...
  {
    number: "04",
    name: "Pilates Junction Amsterdam",
    neighborhood: "Amsterdam-Oost",
    priceLevel: "€€",
    review: "Pilates Junction has developed a devoted following in the Oost neighbourhood through consistently high instruction quality and a relaxed, inclusive atmosphere that stands out in Amsterdam's increasingly trend-driven wellness market. The studio teaches both mat and reformer Pilates to a diverse clientele ranging from complete beginners to experienced practitioners, and the bilingual teaching (Dutch/English) makes it one of the most accessible studios for international residents. An excellent neighbourhood studio.",
    address: "Linnaeusstraat 89, 1093 EK Amsterdam",
    bestFor: "Bilingual instruction, beginners, neighbourhood community",
    signatureClass: "Mat & Reformer Blend",
    bookingTip: "The beginner mat series runs in six-week blocks and is the best structured entry point for newcomers. Enrol at the start of a block for the full benefit.",
  },
  {
    number: "05",
