...
const PRODUCT_CATEGORIES = [
  {
    ...
    items: [
      { name: "Premium Pilates Mat", description: "6mm closed-cell foam with non-slip texture on both sides. The reliable foundation of any home or travel practice.", price: "From $52", affiliateUrl: "https://www.amazon.com/s?k=pilates+mat+6mm+non+slip&tag=pilatescollective-20", imageUrl: "/pictures/esma-eserghep-NUQi80iMLrI-unsplash.jpg" },
      { name: "Pilates Grip Socks", description: "Full-toe coverage, seamless construction. Non-negotiable for reformer work — keeps you connected to the foot bar.", price: "From $16", affiliateUrl: "https://www.amazon.com/s?k=pilates+grip+socks+toesox&tag=pilatescollective-20", imageUrl: "/pictures/jade-stephens-N21356amsyw-unsplash.jpg" },
      { name: "Magic Circle", description: "The original Pilates prop. Firm but flexible resistance, dual foam handles. Essential for inner thigh and arm work.", price: "From $24", affiliateUrl: "https://www.amazon.com/s?k=pilates+magic+circle+resistance+ring&tag=pilatescollective-20", imageUrl: "/pictures/ginny-rose-stewart-UxkcSzRWM2s-unsplash.jpg" },
      { name: "Foam Roller", description: "High-density EVA foam. Doubles as a myofascial release tool and balance prop — one of the most versatile pieces in the kit.", price: "From $32", affiliateUrl: "https://www.amazon.com/s?k=high+density+foam+roller+pilates&tag=pilatescollective-20", imageUrl: "/pictures/henrique-ferreira-omiTbS-nb_M-unsplash.jpg" },
      { name: "Pilates Cork Block", description: "Firm cork support for seated modifications, spinal extension work, and elevated footwork. More stable than foam, better grip under load.", price: "From $18", affiliateUrl: "https://www.amazon.com/s?k=cork+yoga+block+pilates+support&tag=pilatescollective-20", imageUrl: "/pictures/dane-wetton-AkSJQnem75Y-unsplash.jpg" },
      { name: "Massage Ball Set", description: "Dual lacrosse-style balls for targeted myofascial release. Indispensable for foot, glute, and thoracic work between sessions.", price: "From $14", affiliateUrl: "https://www.amazon.com/s?k=massage+ball+set+myofascial+release+pilates&tag=pilatescollective-20", imageUrl: "/pictures/ahmet-kurt-a1IhqqW8JQE-unsplash.jpg" },
    ],
  },
  {
    label: "Props & Resistance",
    items: [
      { name: "Mini Stability Ball", description: "The 9-inch ball transforms mat work entirely. Adds tactile feedback, precise cueing, and progressive resistance to dozens of exercises.", price: "From $18", affiliateUrl: "https://www.amazon.com/s?k=pilates+mini+stability+ball+9+inch&tag=pilatescollective-20", imageUrl: "/pictures/ahmet-kurt-0fiVrPJg5kU-unsplash.jpg" },
      { name: "Resistance Bands Set", description: "Fabric-wrapped loops in three resistance levels. Versatile, portable, and far more useful than basic latex therabands.", price: "From $22", affiliateUrl: "https://www.amazon.com/s?k=fabric+resistance+bands+set+pilates&tag=pilatescollective-20", imageUrl: "/pictures/junseong-lee-AX8cf6mkCzw-unsplash.jpg" },
      { name: "Pilates Ankle Weights", description: "Neoprene-wrapped, 1–3 lb per leg. Adds meaningful load to the leg circle series, standing footwork, and arabesque variations.", price: "From $28", affiliateUrl: "https://www.amazon.com/s?k=pilates+ankle+weights+1+2+3+lb&tag=pilatescollective-20", imageUrl: "/pictures/juls-p-lB6lbkbe1XA-unsplash.jpg" },
      { name: "Stability Ball (55cm)", description: "For practitioners 5'1\" to 5'7\". Ideal for spinal rolling, seated balance work, and open-chain leg exercises.", price: "From $28", affiliateUrl: "https://www.amazon.com/s?k=pilates+exercise+stability+ball+55cm&tag=pilatescollective-20", imageUrl: "/pictures/dane-wetton-t1NEMSm1rgI-unsplash.jpg" },
      { name: "Theraband Flexbar", description: "For grip strength and wrist rehabilitation. Increasingly used in Pilates for hand and forearm conditioning in reformer prep work.", price: "From $20", affiliateUrl: "https://www.amazon.com/s?k=theraband+flexbar+resistance+bar&tag=pilatescollective-20", imageUrl: "/pictures/samantha-sheppard-b8Q5fHBsyik-unsplash.jpg" },
      { name: "Pilates Wedge", description: "Slanted foam support for wrist protection during planks and push-ups. Reduces extension load — essential for practitioners with wrist sensitivity.", price: "From $22", affiliateUrl: "https://www.amazon.com/s?k=pilates+yoga+wedge+wrist+support&tag=pilatescollective-20", imageUrl: "/pictures/roxana-popovici-5JQxj-zc5ng-unsplash.jpg" },
      { name: "Long Resistance Band", description: "2-metre looped band in light, medium, and heavy. Essential for the arm series, footwork variations, and full-body stretching sequences.", price: "From $12", affiliateUrl: "https://www.amazon.com/s?k=long+resistance+band+set+pilates+exercise&tag=pilatescollective-20", imageUrl: "/pictures/elena-kloppenburg-erUC4fTtCuo-unsplash.jpg" },
      { name: "Pilates Toning Balls", description: "Weighted soft-grip balls (0.5–1 lb each) for arm, shoulder, and standing balance work. Adds meaningful load without disrupting the Pilates flow.", price: "From $24", affiliateUrl: "https://www.amazon.com/s?k=pilates+toning+balls+weighted&tag=pilatescollective-20", imageUrl: "/pictures/roxana-popovici-Zp4APUiwEsM-unsplash.jpg" },
    ],
  },
  {
    label: "Home Studio",
    items: [
      { name: "Entry-Level Reformer", description: "The AeroPilates 435 delivers 75% of a studio reformer's exercise range at home. The most recommended entry point in this price bracket.", price: "From $399", affiliateUrl: "https://www.amazon.com/s?k=pilates+reformer+home+aeropilates&tag=pilatescollective-20", imageUrl: "/pictures/roxana-popovici-aY5uOJ2o96g-unsplash.jpg" },
      { name: "Pilates Barrel", description: "The ladder barrel is the gateway to spinal articulation work that can't be replicated on a mat. A considered home studio investment.", price: "From $185", affiliateUrl: "https://www.amazon.com/s?k=pilates+ladder+barrel&tag=pilatescollective-20", imageUrl: "/pictures/roxana-popovici-hiHBILFNah4-unsplash.jpg" },
      { name: "Spine Corrector", description: "Brooke Siler's preferred prop for teaching spinal extension and opening the chest. More versatile than it appears and compact enough for any space.", price: "From $95", affiliateUrl: "https://www.amazon.com/s?k=pilates+spine+corrector&tag=pilatescollective-20", imageUrl: "/pictures/logan-weaver-lgnwvr-u76Gd0hP5w4-unsplash.jpg" },
      { name: "Wunda Chair", description: "Joseph Pilates' most underrated invention. Challenges every plane of movement in a compact footprint — ideal for a serious home practice.", price: "From $320", affiliateUrl: "https://www.amazon.com/s?k=pilates+wunda+chair&tag=pilatescollective-20", imageUrl: "/pictures/mathilde-langevin-aBJ3A-2LJyU-unsplash.jpg" },
      { name: "Arc Barrel", description: "The arc is the most compact barrel available — ideal for spinal extension, hip flexor opening, and side-lying work in smaller spaces.", price: "From $130", affiliateUrl: "https://www.amazon.com/s?k=pilates+arc+barrel&tag=pilatescollective-20", imageUrl: "/pictures/ginny-rose-stewart-UxkcSzRWM2s-unsplash.jpg" },
      { name: "Jump Board", description: "Turns any home reformer into a cardio and plyometric platform. Low-impact vertical jumping sequences — the single best reformer add-on for circulation.", price: "From $95", affiliateUrl: "https://www.amazon.com/s?k=pilates+reformer+jump+board&tag=pilatescollective-20", imageUrl: "/pictures/ahmet-kurt-0xn-8kRWOhE-unsplash.jpg" },
      { name: "Balanced Body CoreAlign", description: "The CoreAlign targets functional upright movement — standing balance, gait, and dynamic core stability — in ways the reformer alone cannot replicate.", price: "From $1,200", affiliateUrl: "https://www.amazon.com/s?k=balanced+body+corealign+pilates&tag=pilatescollective-20", imageUrl: "/pictures/roxana-popovici-hiHBILFNah4-unsplash.jpg" },
      { name: "Pilates Cadillac / Tower", description: "The full Cadillac apparatus — or a reformer tower conversion — opens the complete classical repertoire. The most comprehensive piece of Pilates equipment available.", price: "From $1,800", affiliateUrl: "https://www.amazon.com/s?k=pilates+cadillac+tower+apparatus&tag=pilatescollective-20", imageUrl: "/pictures/samantha-sheppard-b8Q5fHBsyik-unsplash.jpg" },
      { name: "Reformer Accessories Kit", description: "Long box, short box, sticky pads, and leather straps. The accessories that meaningfully expand the reformer repertoire beyond the foundation exercises.", price: "From $85", affiliateUrl: "https://www.amazon.com/s?k=pilates+reformer+accessories+box+straps&tag=pilatescollective-20", imageUrl: "/pictures/elena-kloppenburg-erUC4fTtCuo-unsplash.jpg" },
    ],
  },
  {
    label: "Apparel",
    items: [
      { name: "Pilates Leggings", description: "High-waist compression leggings that stay opaque in forward fold and don't roll during footwork. The Lululemon Align and CRZ YOGA Butterluxe are the benchmarks.", price: "From $28", affiliateUrl: "https://www.amazon.com/s?k=pilates+leggings+high+waist+compression&tag=pilatescollective-20", imageUrl: "/pictures/roxana-popovici-lKe5jm-Sypw-unsplash.jpg" },
      { name: "Pilates Sports Bra", description: "Medium-support bralette that keeps the instructor's sightlines clear. The Lululemon Free to Be and Alo Airlift are the most-worn at reformer studios worldwide.", price: "From $35", affiliateUrl: "https://www.amazon.com/s?k=pilates+sports+bra+medium+support&tag=pilatescollective-20", imageUrl: "/pictures/jessica-streser-5ai6kpW4NOw-unsplash.jpg" },
      { name: "Pilates Biker Shorts", description: "5–6 inch inseam biker shorts let instructors see your knee tracking clearly. The Lululemon Align Short and Alo Airbrush are the studio standards.", price: "From $28", affiliateUrl: "https://www.amazon.com/s?k=pilates+biker+shorts+high+waist&tag=pilatescollective-20", imageUrl: "/pictures/ginny-rose-stewart-UxkcSzRWM2s-unsplash.jpg" },
      { name: "Pilates Ankle Weights", description: "Bala Bangles (1 lb) are the boutique studio standard. The secure magnetic clasp and flat profile stay in position throughout the full Pilates series.", price: "From $22", affiliateUrl: "https://www.amazon.com/s?k=bala+bangles+ankle+weights+pilates&tag=pilatescollective-20", imageUrl: "/pictures/jade-stephens-N21356amsyw-unsplash.jpg" },
    ],
  },
  {
    label: "Premium Reformers",
    items: [
      { name: "Merrithew SPX Max", description: "The professional studio standard used in accredited training centres worldwide. Full 5-spring system, 97-inch rail, 350 lb capacity. The entry point to serious home practice.", price: "From $2,199", affiliateUrl: "https://www.amazon.com/s?k=merrithew+spx+max+reformer&tag=pilatescollective-20", imageUrl: "/pictures/esma-eserghep-NUQi80iMLrI-unsplash.jpg" },
      { name: "Balanced Body Allegro 2", description: "Carbon fibre carriage tracks, Infinity Footbar, and a 10-year frame warranty. The most recommended premium home reformer by master instructors. $3,995.", price: "$3,995", affiliateUrl: "https://www.amazon.com/s?k=balanced+body+allegro+2+reformer&tag=pilatescollective-20", imageUrl: "/pictures/roxana-popovici-aY5uOJ2o96g-unsplash.jpg" },
      { name: "Merrithew V2 Max", description: "Merrithew's most advanced machine. Patented retractable rope system, 24-inch carriage, high-precision springs. The quietest reformer in the Merrithew range.", price: "From $3,500", affiliateUrl: "https://www.amazon.com/s?k=merrithew+v2+max+reformer&tag=pilatescollective-20", imageUrl: "/pictures/samantha-sheppard-b8Q5fHBsyik-unsplash.jpg" },
      { name: "Gratz Universal Reformer", description: "The original. Built since 1965 under Joseph Pilates' direction, handmade in New York. Four springs, 3-gear bar, unchanged in six decades. $4,995–$5,295.", price: "From $4,995", affiliateUrl: "https://www.gratzpilates.com/collections/reformers", imageUrl: "/pictures/roxana-popovici-cZ0WYsBFHhs-unsplash.jpg" },
    ],
  },
];
      ...
      <main>
        ...
        <section style={{
          ...
          <div style={{
            ...
            <p style={{ fontFamily: "var(--font-sans)", fontSize: "10px", fontWeight: 500, letterSpacing: "0.22em", textTransform: "uppercase" as const, color: "rgba(255,255,255,0.55)", margin: 0 }}>Pilates Collective Club</p>
            <p style={{ fontFamily: "var(--font-sans)", fontSize: "10px", fontWeight: 400, letterSpacing: "0.15em", textTransform: "uppercase" as const, color: "rgba(255,255,255,0.35)", margin: 0 }}>Est. 2026</p>
          </div>
          <div style={{ position: "relative", zIndex: 2, padding: "0 52px 64px", maxWidth: "1300px", width: "100%" }}>
            <div style={{ width: "48px", height: "1px", backgroundColor: "#c5a882", marginBottom: "28px" }} />
            <h1 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(48px, 7.5vw, 112px)", fontWeight: 300, lineHeight: 0.98, color: "#ffffff", letterSpacing: "-0.02em", marginBottom: "36px", maxWidth: "780px" }}>
              From the<br />
              powerhouse,<br />
              <em style={{ color: "#c5a882" }}>everything follows.</em>
            </h1>
            <div style={{ display: "flex", alignItems: "center", gap: "32px", flexWrap: "wrap" }}>
              <p style={{ fontFamily: "var(--font-sans)", fontSize: "13px", fontWeight: 300, color: "rgba(255,255,255,0.55)", lineHeight: 1.7, maxWidth: "380px", margin: 0, letterSpacing: "0.01em" }}>
                Curated studio guides, editorial reviews, and the best in Pilates equipment — written by practitioners.
              </p>
              <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
                <Link href="/blog" style={{ fontFamily: "var(--font-sans)", fontSize: "10px", fontWeight: 500, letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "#0a0a0a", textDecoration: "none", backgroundColor: "#ffffff", padding: "13px 26px", display: "inline-block" }}>Read the Journal</Link>
                <Link href="/#cities" style={{ fontFamily: "var(--font-sans)", fontSize: "10px", fontWeight: 500, letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "#ffffff", textDecoration: "none", border: "1px solid rgba(255,255,255,0.4)", padding: "13px 26px", display: "inline-block" }}>Browse Studios</Link>
              </div>
            </div>
          </div>
          <div style={{ position: "absolute", bottom: "36px", right: "52px", zIndex: 2, display: "flex", flexDirection: "column" as const, alignItems: "center", gap: "8px" }}>
            <p style={{ fontFamily: "var(--font-sans)", fontSize: "9px", fontWeight: 400, letterSpacing: "0.2em", textTransform: "uppercase" as const, color: "rgba(255,255,255,0.3)", margin: 0, writingMode: "vertical-rl" as const }}>Scroll</p>
          ...
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            <div className="pcc-section-header" style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: "64px" }}>
              <div>
                ...
                <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(32px, 4vw, 48px)", fontWeight: 400, color: "#0a0a0a", margin: 0 }}>Editor&apos;s essentials</h2>
              </div>
              <p style={{ fontFamily: "var(--font-sans)", fontSize: "13px", fontWeight: 300, color: "#9a9490", margin: 0 }}>Carefully selected. Available on Amazon.</p>
            </div>
            {PRODUCT_CATEGORIES.map((cat, ci) => (
              <div key={cat.label} style={{ marginBottom: ci < PRODUCT_CATEGORIES.length - 1 ? "72px" : 0 }}>
                ...
                <div className="pcc-grid-products" style={{ display: "grid", gap: "24px" }}>
                  {cat.items.map((p) => (<ProductCard key={p.name} {...p} />))}
                </div>
              </div>
            ))}
          </div>
          ...
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            <div className="pcc-section-header" style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: "52px" }}>
              <div>
                ...
                <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(32px, 4vw, 48px)", fontWeight: 400, color: "#0a0a0a", margin: 0 }}>Studio guides by city</h2>
              </div>
              <Link href="/cities/zurich" style={{ fontFamily: "var(--font-sans)", fontSize: "10px", fontWeight: 500, letterSpacing: "0.15em", textTransform: "uppercase", color: "#9a9490", textDecoration: "none", borderBottom: "1px solid #9a9490", paddingBottom: "2px" }}>All cities</Link>
            </div>
          ...
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            <div className="pcc-section-header" style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: "8px" }}>
              <div>
                ...
                <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(32px, 4vw, 48px)", fontWeight: 400, color: "#0a0a0a", margin: 0 }}>Journal</h2>
              </div>
              <Link href="/blog" style={{ fontFamily: "var(--font-sans)", fontSize: "10px", fontWeight: 500, letterSpacing: "0.15em", textTransform: "uppercase", color: "#9a9490", textDecoration: "none", borderBottom: "1px solid #9a9490", paddingBottom: "2px" }}>All articles</Link>
            </div>
        ...
        <section id="about" className="pcc-hp-section" style={{ padding: "120px 40px", backgroundColor: "#ffffff" }}>
          <div style={{ maxWidth: "640px", margin: "0 auto", textAlign: "center" }}>
            ...
            <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(28px, 3.5vw, 42px)", fontWeight: 400, color: "#0a0a0a", marginBottom: "32px", lineHeight: 1.2 }}>Built by practitioners,<br />for practitioners.</h2>
            <p style={{ fontFamily: "var(--font-sans)", fontSize: "15px", fontWeight: 300, color: "#6b6560", lineHeight: 1.85, marginBottom: "20px" }}>We are a small team of passionate Pilates practitioners who got tired of sifting through generic fitness directories to find truly great studios. So we built our own.</p>
            <p style={{ fontFamily: "var(--font-sans)", fontSize: "14px", fontWeight: 300, color: "#9a9490", lineHeight: 1.85 }}>Every studio in our guides has been personally vetted. Every equipment pick has been tested. Every recommendation is independent — we are never paid to feature a studio.</p>
          </div>
        </section>
      </main>
      <Footer />
